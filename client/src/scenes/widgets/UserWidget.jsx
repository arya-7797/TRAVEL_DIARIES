...
const UserWidget = ({ userId, picturePath }) => {
  ...
  const updateUser = (userInfos) => {
    ...
    setLocation(userInfos?.location);
  ...
  const getUser = async () => {
    try {
      ...
      console.log("UserWidget err ", error);
    }
  };
  useEffect(() => {
    getUser();
    ...
    <WidgetWrapper>
      ...
      >
        ...
        <>
          ...
          />
          <EditOutlined onClick={(e) => setEditProfile(true)} />
        </>
      </FlexBetween>
      ...
      <Box p="1rem 0">
        ...
        <Box display="flex" alignItems="center" gap="1rem">
          <LocalPhoneIcon fontSize="large" sx={{ color: main }} />
